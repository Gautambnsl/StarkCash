...
async function main() {
  ...
  const compiledSierra = json.parse(
    fs
      .readFileSync("target/dev/lending_protocol3_erc_20.contract_class.json")
      .toString("ascii")
  );
  const compiledCasm = json.parse(
    fs
      .readFileSync(
        "target/dev/lending_protocol3_erc_20.compiled_contract_class.json"
      )
      .toString("ascii")
  );
  ...
  const contractClassHash =
    "0x160b609e8a93a90a09638afd57fbfec525c61f3adce114e9781497249eb3eb5"; //deployResponse.class_hash;
